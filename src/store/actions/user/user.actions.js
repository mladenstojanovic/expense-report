...
const GET_AUTH_TOKEN_START = '[LOADING] Get Auth Token Start';
const CREATE_USER_START = '[LOADING] Create User Start';
const ADD_BANK_CONNECTION_START = '[LOADING] Add Bank Connection Start';
const GET_TRANSACTIONS_START = '[LOADING] Get Transactions Start';
